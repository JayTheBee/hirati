...
function OutputProcessing({ results, isBatch }) {
...
function OutputDetails({ results, isBatch, index }) {
  return (
    <>
      {isBatch && (
      <h1>
...
function BatchSubmission({
  code, lang, casevar, setCode, setLang, setCase,
}) {
